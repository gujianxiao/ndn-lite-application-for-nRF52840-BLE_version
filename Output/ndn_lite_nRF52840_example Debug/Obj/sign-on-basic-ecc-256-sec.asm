	...
	.eabi_attribute 34, 1
	.eabi_attribute 18, 4
	.file	"sign-on-basic-ecc-256-sec.c"
	.text
.Ltext0:
	.section	.text.sign_on_basic_ecc_256_gen_sha256_hash,"ax",%progbits
	.align	1
	.global	sign_on_basic_ecc_256_gen_sha256_hash
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	sign_on_basic_ecc_256_gen_sha256_hash, %function
sign_on_basic_ecc_256_gen_sha256_hash:
.LFB0:
	.file 1 "C:\\Users\\edwar\\Desktop\\ndn-lite-work\\ndn-lite\\app-support\\bootstrapping\\secure-sign-on\\variants\\ecc_256\\sign-on-basic-ecc-256-sec.c"
	.loc 1 18 0
...
.LCFI1:
	...
	ldr	r1, [sp, #8]
	ldr	r0, [sp, #12]
	bl	sign_on_basic_gen_sha256_hash
	mov	r3, r0
	.loc 1 22 0
	mov	r0, r3
	add	sp, sp, #20
.LCFI2:
	...
	ldr	pc, [sp], #4
.LFE0:
	.size	sign_on_basic_ecc_256_gen_sha256_hash, .-sign_on_basic_ecc_256_gen_sha256_hash
	.section	.text.sign_on_basic_ecc_256_decrypt_kd_pri,"ax",%progbits
	.align	1
	.global	sign_on_basic_ecc_256_decrypt_kd_pri
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	sign_on_basic_ecc_256_decrypt_kd_pri, %function
...
.LCFI4:
	...
	ldr	r1, [sp, #16]
	ldr	r0, [sp, #20]
	bl	sign_on_basic_aes_cbc_decrypt
	str	r0, [sp, #28]
	.loc 1 33 0
	ldr	r3, [sp, #48]
	movs	r2, #32
...
.LCFI5:
	...
	ldr	pc, [sp], #4
.LFE1:
	.size	sign_on_basic_ecc_256_decrypt_kd_pri, .-sign_on_basic_ecc_256_decrypt_kd_pri
	.section	.text.sign_on_basic_ecc_256_vrfy_btstrp_rqst_rspns_sig,"ax",%progbits
	.align	1
	.global	sign_on_basic_ecc_256_vrfy_btstrp_rqst_rspns_sig
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	sign_on_basic_ecc_256_vrfy_btstrp_rqst_rspns_sig, %function
...
.LCFI7:
	...
	ldr	r1, [sp, #16]
	ldr	r0, [sp, #20]
	bl	sign_on_basic_vrfy_hmac_sha256_sig
	mov	r3, r0
	.loc 1 44 0
	mov	r0, r3
	add	sp, sp, #28
.LCFI8:
	...
	ldr	pc, [sp], #4
.LFE2:
	.size	sign_on_basic_ecc_256_vrfy_btstrp_rqst_rspns_sig, .-sign_on_basic_ecc_256_vrfy_btstrp_rqst_rspns_sig
	.section	.text.sign_on_basic_ecc_256_vrfy_cert_rqst_rspns_sig,"ax",%progbits
	.align	1
	.global	sign_on_basic_ecc_256_vrfy_cert_rqst_rspns_sig
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	sign_on_basic_ecc_256_vrfy_cert_rqst_rspns_sig, %function
...
.LCFI11:
	...
	ldr	pc, [sp], #4
.LFE3:
	.size	sign_on_basic_ecc_256_vrfy_cert_rqst_rspns_sig, .-sign_on_basic_ecc_256_vrfy_cert_rqst_rspns_sig
	.section	.text.sign_on_basic_ecc_256_gen_btstrp_rqst_sig,"ax",%progbits
	.align	1
	.global	sign_on_basic_ecc_256_gen_btstrp_rqst_sig
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	sign_on_basic_ecc_256_gen_btstrp_rqst_sig, %function
...
.LCFI13:
	...
	ldr	r2, [sp, #24]
	ldr	r0, [sp, #28]
	bl	sign_on_basic_gen_sha256_ecdsa_sig
	mov	r3, r0
	.loc 1 62 0
	mov	r0, r3
	add	sp, sp, #36
.LCFI14:
	...
	ldr	pc, [sp], #4
.LFE4:
	.size	sign_on_basic_ecc_256_gen_btstrp_rqst_sig, .-sign_on_basic_ecc_256_gen_btstrp_rqst_sig
	.section	.text.sign_on_basic_ecc_256_gen_cert_rqst_sig,"ax",%progbits
	.align	1
	.global	sign_on_basic_ecc_256_gen_cert_rqst_sig
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	sign_on_basic_ecc_256_gen_cert_rqst_sig, %function
...
.LCFI17:
	...
	ldr	pc, [sp], #4
.LFE5:
	.size	sign_on_basic_ecc_256_gen_cert_rqst_sig, .-sign_on_basic_ecc_256_gen_cert_rqst_sig
	.section	.text.sign_on_basic_ecc_256_gen_fin_msg_sig,"ax",%progbits
	.align	1
	.global	sign_on_basic_ecc_256_gen_fin_msg_sig
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	sign_on_basic_ecc_256_gen_fin_msg_sig, %function
...
.LCFI20:
	...
	ldr	pc, [sp], #4
.LFE6:
	.size	sign_on_basic_ecc_256_gen_fin_msg_sig, .-sign_on_basic_ecc_256_gen_fin_msg_sig
	.section	.text.sign_on_basic_ecc_256_gen_n1_keypair,"ax",%progbits
	.align	1
	.global	sign_on_basic_ecc_256_gen_n1_keypair
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	sign_on_basic_ecc_256_gen_n1_keypair, %function
...
.LCFI22:
	...
	ldr	r1, [sp, #24]
	ldr	r0, [sp, #28]
	bl	sign_on_basic_gen_ec_keypair
	mov	r3, r0
	.loc 1 95 0
	mov	r0, r3
	add	sp, sp, #36
.LCFI23:
	...
	ldr	pc, [sp], #4
.LFE7:
	.size	sign_on_basic_ecc_256_gen_n1_keypair, .-sign_on_basic_ecc_256_gen_n1_keypair
	.section	.text.sign_on_basic_ecc_256_gen_kt,"ax",%progbits
	.align	1
	.global	sign_on_basic_ecc_256_gen_kt
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	sign_on_basic_ecc_256_gen_kt, %function
...
.LCFI25:
	...
	ldr	r1, [sp, #24]
	ldr	r0, [sp, #28]
	bl	sign_on_basic_gen_ecdh_shared_secret
	mov	r3, r0
	.loc 1 106 0
	mov	r0, r3
	add	sp, sp, #36
.LCFI26:
	...
	ldr	pc, [sp], #4
.LFE8:
	.size	sign_on_basic_ecc_256_gen_kt, .-sign_on_basic_ecc_256_gen_kt
...
.Ldebug_abbrev0:
	...
	.4byte	0x987
	.4byte	0x5a6
	.ascii	"sign_on_basic_ecc_256_gen_kt\000"
	.4byte	0x628
	.ascii	"sign_on_basic_ecc_256_gen_n1_keypair\000"
	.4byte	0x696
	.ascii	"sign_on_basic_ecc_256_gen_fin_msg_sig\000"
	.4byte	0x704
	.ascii	"sign_on_basic_ecc_256_gen_cert_rqst_sig\000"
	.4byte	0x772
	.ascii	"sign_on_basic_ecc_256_gen_btstrp_rqst_sig\000"
	.4byte	0x7e0
	.ascii	"sign_on_basic_ecc_256_vrfy_cert_rqst_rspns_sig\000"
	.4byte	0x84e
	.ascii	"sign_on_basic_ecc_256_vrfy_btstrp_rqst_rspns_sig\000"
	.4byte	0x8bc
	.ascii	"sign_on_basic_ecc_256_decrypt_kd_pri\000"
	.4byte	0x946
	.ascii	"sign_on_basic_ecc_256_gen_sha256_hash\000"
	.4byte	0
...
.Ldebug_macro0:
	...
	.4byte	.Ldebug_macro2
	.byte	0x4
	.file 5 "C:/Program Files/SEGGER/SEGGER Embedded Studio for ARM 4.10/include/stddef.h"
	.byte	0x3
	.uleb128 0xf
	.uleb128 0x5
	.byte	0x5
...
.LASF755:
	...
	.ascii	"app-support\\bootstrapping\\secure-sign-on\\variant"
	.ascii	"s\\ecc_256\\sign-on-basic-ecc-256-sec.c\000"
.LASF133:
...
.LASF751:
	.ascii	"decrypted_kd_pri_buf_len\000"
.LASF98:
...
.LASF749:
	.ascii	"encrypted_kd_pri_len\000"
.LASF758:
	.ascii	"ret_val\000"
.LASF386:
...
.LASF731:
	.ascii	"sign_on_basic_ecc_256_gen_n1_keypair\000"
.LASF752:
	.ascii	"decrypted_kd_pri_len\000"
.LASF234:
